...
/proc/slot2body_zone(slot)
	switch(slot)
		if(ITEM_SLOT_BACK, ITEM_SLOT_OCLOTHING, ITEM_SLOT_ICLOTHING, ITEM_SLOT_BELT, ITEM_SLOT_ID, ITEM_SLOT_ARMOR, ITEM_SLOT_SPECSTORAGE, ITEM_SLOT_CHESTRIG, ITEM_SLOT_UNDERTOP) // OUTERBOUNDS ADDITION - Added armor secstorage, chestrig, and undertop
